...
-- i='車' i_mdi_pin=$i
-- i='賈' i_mdi_pin_off=$i
-- i='滑' i_mdi_pine_tree=$i
-- i='串' i_mdi_pine_tree_box=$i
-- i='句' i_mdi_pinterest=$i
-- i='龜' i_mdi_pinterest_box=$i
-- i='龜' i_mdi_pizza=$i
-- i='契' i_mdi_play=$i
-- i='金' i_mdi_play_box_outline=$i
-- i='喇' i_mdi_play_circle=$i
-- i='奈' i_mdi_play_circle_outline=$i
-- i='懶' i_mdi_play_pause=$i
-- i='癩' i_mdi_play_protected_content=$i
-- i='羅' i_mdi_playlist_minus=$i
-- i='蘿' i_mdi_playlist_play=$i
-- i='螺' i_mdi_playlist_plus=$i
-- i='裸' i_mdi_playlist_remove=$i
-- i='邏' i_mdi_playstation=$i
-- i='樂' i_mdi_plus=$i
-- i='洛' i_mdi_plus_box=$i
-- i='烙' i_mdi_plus_circle=$i
-- i='珞' i_mdi_plus_circle_multiple_outline=$i
-- i='落' i_mdi_plus_circle_outline=$i
-- i='酪' i_mdi_plus_network=$i
-- i='駱' i_mdi_plus_one=$i
-- i='亂' i_mdi_pocket=$i
-- i='卵' i_mdi_pokeball=$i
-- i='欄' i_mdi_polaroid=$i
-- i='爛' i_mdi_poll=$i
-- i='蘭' i_mdi_poll_box=$i
-- i='鸞' i_mdi_polymer=$i
-- i='嵐' i_mdi_popcorn=$i
-- i='濫' i_mdi_pound=$i
-- i='藍' i_mdi_pound_box=$i
-- i='襤' i_mdi_power=$i
-- i='拉' i_mdi_power_settings=$i
-- i='臘' i_mdi_power_socket=$i
-- i='蠟' i_mdi_presentation=$i
-- i='廊' i_mdi_presentation_play=$i
-- i='朗' i_mdi_printer=$i
-- i='浪' i_mdi_printer_3d=$i
-- i='狼' i_mdi_printer_alert=$i
-- i='郎' i_mdi_professional_hexagon=$i
-- i='來' i_mdi_projector=$i
-- i='冷' i_mdi_projector_screen=$i
-- i='勞' i_mdi_pulse=$i
-- i='擄' i_mdi_puzzle=$i
-- i='櫓' i_mdi_qrcode=$i
-- i='爐' i_mdi_qrcode_scan=$i
-- i='盧' i_mdi_quadcopter=$i
-- i='老' i_mdi_quality_high=$i
-- i='蘆' i_mdi_quicktime=$i
-- i='虜' i_mdi_radar=$i
-- i='路' i_mdi_radiator=$i
-- i='露' i_mdi_radio=$i
-- i='魯' i_mdi_radio_handheld=$i
-- i='鷺' i_mdi_radio_tower=$i
-- i='碌' i_mdi_radioactive=$i
-- i='祿' i_mdi_radiobox_blank=$i
-- i='綠' i_mdi_radiobox_marked=$i
-- i='菉' i_mdi_raspberrypi=$i
-- i='錄' i_mdi_ray_end=$i
-- i='鹿' i_mdi_ray_end_arrow=$i
-- i='論' i_mdi_ray_start=$i
-- i='壟' i_mdi_ray_start_arrow=$i
-- i='弄' i_mdi_ray_start_end=$i
-- i='籠' i_mdi_ray_vertex=$i
-- i='聾' i_mdi_lastpass=$i
-- i='牢' i_mdi_read=$i
-- i='磊' i_mdi_youtube_tv=$i
-- i='賂' i_mdi_receipt=$i
-- i='雷' i_mdi_record=$i
-- i='壘' i_mdi_record_rec=$i
-- i='屢' i_mdi_recycle=$i
-- i='樓' i_mdi_reddit=$i
-- i='淚' i_mdi_redo=$i
-- i='漏' i_mdi_redo_variant=$i
-- i='累' i_mdi_refresh=$i
-- i='縷' i_mdi_regex=$i
-- i='陋' i_mdi_relative_scale=$i
-- i='勒' i_mdi_reload=$i
-- i='肋' i_mdi_remote=$i
-- i='凜' i_mdi_rename_box=$i
-- i='凌' i_mdi_repeat=$i
-- i='稜' i_mdi_repeat_off=$i
-- i='綾' i_mdi_repeat_once=$i
-- i='菱' i_mdi_replay=$i
-- i='陵' i_mdi_reply=$i
-- i='讀' i_mdi_reply_all=$i
-- i='拏' i_mdi_reproduction=$i
-- i='樂' i_mdi_resize_bottom_right=$i
-- i='諾' i_mdi_responsive=$i
-- i='丹' i_mdi_rewind=$i
-- i='寧' i_mdi_ribbon=$i
-- i='怒' i_mdi_road=$i
-- i='率' i_mdi_road_variant=$i
-- i='異' i_mdi_rocket=$i
-- i='北' i_mdi_rotate_3d=$i
-- i='磻' i_mdi_rotate_left=$i
-- i='便' i_mdi_rotate_left_variant=$i
-- i='復' i_mdi_rotate_right=$i
-- i='不' i_mdi_rotate_right_variant=$i
-- i='泌' i_mdi_router_wireless=$i
-- i='數' i_mdi_routes=$i
-- i='索' i_mdi_rss=$i
-- i='參' i_mdi_rss_box=$i
-- i='塞' i_mdi_ruler=$i
-- i='省' i_mdi_run_fast=$i
-- i='葉' i_mdi_sale=$i
-- i='說' i_mdi_satellite=$i
-- i='殺' i_mdi_satellite_variant=$i
-- i='辰' i_mdi_scale=$i
-- i='沈' i_mdi_scale_bathroom=$i
-- i='拾' i_mdi_school=$i
-- i='若' i_mdi_screen_rotation=$i
-- i='掠' i_mdi_screen_rotation_lock=$i
-- i='略' i_mdi_screwdriver=$i
-- i='亮' i_mdi_script=$i
-- i='兩' i_mdi_sd=$i
-- i='凉' i_mdi_seal=$i
-- i='梁' i_mdi_seat_flat=$i
-- i='糧' i_mdi_seat_flat_angled=$i
-- i='良' i_mdi_seat_individual_suite=$i
-- i='諒' i_mdi_seat_legroom_extra=$i
-- i='量' i_mdi_seat_legroom_normal=$i
-- i='勵' i_mdi_seat_legroom_reduced=$i
-- i='呂' i_mdi_seat_recline_extra=$i
-- i='女' i_mdi_seat_recline_normal=$i
-- i='廬' i_mdi_security=$i
-- i='旅' i_mdi_security_network=$i
-- i='濾' i_mdi_select=$i
-- i='礪' i_mdi_select_all=$i
-- i='閭' i_mdi_select_inverse=$i
-- i='驪' i_mdi_select_off=$i
-- i='麗' i_mdi_selection=$i
-- i='黎' i_mdi_send=$i
-- i='力' i_mdi_server=$i
-- i='曆' i_mdi_server_minus=$i
-- i='歷' i_mdi_server_network=$i
-- i='轢' i_mdi_server_network_off=$i
-- i='年' i_mdi_server_off=$i
-- i='憐' i_mdi_server_plus=$i
-- i='戀' i_mdi_server_remove=$i
-- i='撚' i_mdi_server_security=$i
-- i='漣' i_mdi_settings=$i
-- i='煉' i_mdi_settings_box=$i
-- i='璉' i_mdi_shape_plus=$i
-- i='秊' i_mdi_share=$i
-- i='練' i_mdi_share_variant=$i
-- i='聯' i_mdi_shield=$i
-- i='輦' i_mdi_shield_outline=$i
-- i='蓮' i_mdi_shopping=$i
-- i='連' i_mdi_shopping_music=$i
-- i='鍊' i_mdi_shredder=$i
-- i='列' i_mdi_shuffle=$i
-- i='劣' i_mdi_shuffle_disabled=$i
-- i='咽' i_mdi_shuffle_variant=$i
-- i='烈' i_mdi_sigma=$i
-- i='裂' i_mdi_sign_caution=$i
-- i='說' i_mdi_signal=$i
-- i='廉' i_mdi_silverware=$i
-- i='念' i_mdi_silverware_fork=$i
-- i='捻' i_mdi_silverware_spoon=$i
-- i='殮' i_mdi_silverware_variant=$i
-- i='簾' i_mdi_sim=$i
-- i='獵' i_mdi_sim_alert=$i
-- i='令' i_mdi_sim_off=$i
-- i='囹' i_mdi_sitemap=$i
-- i='寧' i_mdi_skip_backward=$i
-- i='嶺' i_mdi_skip_forward=$i
-- i='怜' i_mdi_skip_next=$i
-- i='玲' i_mdi_skip_previous=$i
-- i='瑩' i_mdi_skype=$i
-- i='羚' i_mdi_skype_business=$i
-- i='聆' i_mdi_slack=$i
-- i='鈴' i_mdi_sleep=$i
-- i='零' i_mdi_sleep_off=$i
-- i='靈' i_mdi_smoking=$i
-- i='領' i_mdi_smoking_off=$i
-- i='例' i_mdi_snapchat=$i
-- i='禮' i_mdi_snowman=$i
-- i='醴' i_mdi_soccer=$i
-- i='隸' i_mdi_sofa=$i
-- i='惡' i_mdi_sort=$i
-- i='了' i_mdi_sort_alphabetical=$i
-- i='僚' i_mdi_sort_ascending=$i
-- i='寮' i_mdi_sort_descending=$i
-- i='尿' i_mdi_sort_numeric=$i
-- i='料' i_mdi_sort_variant=$i
-- i='樂' i_mdi_soundcloud=$i
-- i='燎' i_mdi_source_fork=$i
-- i='療' i_mdi_source_pull=$i
-- i='蓼' i_mdi_speaker=$i
-- i='遼' i_mdi_speaker_off=$i
-- i='龍' i_mdi_speedometer=$i
-- i='暈' i_mdi_spellcheck=$i
-- i='阮' i_mdi_spotify=$i
-- i='劉' i_mdi_spotlight=$i
-- i='杻' i_mdi_spotlight_beam=$i
-- i='柳' i_mdi_square_inc=$i
-- i='流' i_mdi_square_inc_cash=$i
-- i='溜' i_mdi_stack_overflow=$i
-- i='琉' i_mdi_stairs=$i
-- i='留' i_mdi_star=$i
-- i='硫' i_mdi_star_circle=$i
-- i='紐' i_mdi_star_half=$i
-- i='類' i_mdi_star_off=$i
-- i='六' i_mdi_star_outline=$i
-- i='戮' i_mdi_steam=$i
-- i='陸' i_mdi_steering=$i
-- i='倫' i_mdi_step_backward=$i
-- i='崙' i_mdi_step_backward_2=$i
-- i='淪' i_mdi_step_forward=$i
-- i='輪' i_mdi_step_forward_2=$i
-- i='律' i_mdi_stethoscope=$i
-- i='慄' i_mdi_stocking=$i
-- i='栗' i_mdi_stop=$i
-- i='率' i_mdi_store=$i
-- i='隆' i_mdi_store_24_hour=$i
-- i='利' i_mdi_stove=$i
-- i='吏' i_mdi_subway_variant=$i
-- i='履' i_mdi_sunglasses=$i
-- i='易' i_mdi_swap_horizontal=$i
-- i='李' i_mdi_swap_vertical=$i
-- i='梨' i_mdi_swim=$i
-- i='泥' i_mdi_switch=$i
-- i='理' i_mdi_sword=$i
-- i='痢' i_mdi_sync=$i
-- i='罹' i_mdi_sync_alert=$i
-- i='裏' i_mdi_sync_off=$i
-- i='裡' i_mdi_tab=$i
-- i='里' i_mdi_tab_unselected=$i
-- i='離' i_mdi_table=$i
-- i='匿' i_mdi_table_column_plus_after=$i
-- i='溺' i_mdi_table_column_plus_before=$i
-- i='吝' i_mdi_table_column_remove=$i
-- i='燐' i_mdi_table_column_width=$i
-- i='璘' i_mdi_table_edit=$i
-- i='藺' i_mdi_table_large=$i
-- i='隣' i_mdi_table_row_height=$i
-- i='鱗' i_mdi_table_row_plus_after=$i
-- i='麟' i_mdi_table_row_plus_before=$i
-- i='林' i_mdi_table_row_remove=$i
-- i='淋' i_mdi_tablet=$i
-- i='臨' i_mdi_tablet_android=$i
-- i='立' i_mdi_tablet_ipad=$i
-- i='笠' i_mdi_tag=$i
-- i='粒' i_mdi_tag_faces=$i
-- i='狀' i_mdi_tag_multiple=$i
-- i='炙' i_mdi_tag_outline=$i
-- i='識' i_mdi_tag_text_outline=$i
-- i='什' i_mdi_target=$i
-- i='茶' i_mdi_taxi=$i
-- i='刺' i_mdi_teamviewer=$i
-- i='切' i_mdi_telegram=$i
-- i='度' i_mdi_television=$i
-- i='拓' i_mdi_television_guide=$i
-- i='糖' i_mdi_temperature_celsius=$i
-- i='宅' i_mdi_temperature_fahrenheit=$i
-- i='洞' i_mdi_temperature_kelvin=$i
-- i='暴' i_mdi_tennis=$i
-- i='輻' i_mdi_tent=$i
-- i='行' i_mdi_terrain=$i
-- i='降' i_mdi_text_to_speech=$i
-- i='見' i_mdi_text_to_speech_off=$i
-- i='廓' i_mdi_texture=$i
-- i='兀' i_mdi_theater=$i
-- i='嗀' i_mdi_theme_light_dark=$i
-- i='﨎' i_mdi_thermometer=$i
-- i='﨏' i_mdi_thermometer_lines=$i
-- i='塚' i_mdi_thumb_down=$i
-- i='﨑' i_mdi_thumb_down_outline=$i
-- i='晴' i_mdi_thumb_up=$i
-- i='﨓' i_mdi_thumb_up_outline=$i
-- i='﨔' i_mdi_thumbs_up_down=$i
-- i='凞' i_mdi_ticket=$i
-- i='猪' i_mdi_ticket_account=$i
-- i='益' i_mdi_ticket_confirmation=$i
-- i='礼' i_mdi_tie=$i
-- i='神' i_mdi_timelapse=$i
-- i='祥' i_mdi_timer=$i
-- i='福' i_mdi_timer_10=$i
-- i='靖' i_mdi_timer_3=$i
-- i='精' i_mdi_timer_off=$i
-- i='羽' i_mdi_timer_sand=$i
-- i='﨟' i_mdi_timetable=$i
-- i='蘒' i_mdi_toggle_switch=$i
-- i='﨡' i_mdi_toggle_switch_off=$i
-- i='諸' i_mdi_tooltip=$i
-- i='﨣' i_mdi_tooltip_edit=$i
-- i='﨤' i_mdi_tooltip_image=$i
-- i='逸' i_mdi_tooltip_outline=$i
-- i='都' i_mdi_tooltip_outline_plus=$i
-- i='﨧' i_mdi_tooltip_text=$i
-- i='﨨' i_mdi_tooth=$i
-- i='﨩' i_mdi_tor=$i
-- i='飯' i_mdi_traffic_light=$i
-- i='飼' i_mdi_train=$i
-- i='館' i_mdi_tram=$i
-- i='鶴' i_mdi_transcribe=$i
-- i='郞' i_mdi_transcribe_close=$i
-- i='隷' i_mdi_transfer=$i
-- i='侮' i_mdi_tree=$i
-- i='僧' i_mdi_trello=$i
-- i='免' i_mdi_trending_down=$i
-- i='勉' i_mdi_trending_neutral=$i
-- i='勤' i_mdi_trending_up=$i
-- i='卑' i_mdi_triangle=$i
-- i='喝' i_mdi_triangle_outline=$i
-- i='嘆' i_mdi_trophy=$i
-- i='器' i_mdi_trophy_award=$i
-- i='塀' i_mdi_trophy_outline=$i
-- i='墨' i_mdi_trophy_variant=$i
-- i='層' i_mdi_trophy_variant_outline=$i
-- i='屮' i_mdi_truck=$i
-- i='悔' i_mdi_truck_delivery=$i
-- i='慨' i_mdi_tshirt_crew=$i
-- i='憎' i_mdi_tshirt_v=$i
-- i='懲' i_mdi_tumblr=$i
-- i='敏' i_mdi_tumblr_reblog=$i
-- i='既' i_mdi_twitch=$i
-- i='暑' i_mdi_twitter=$i
-- i='梅' i_mdi_twitter_box=$i
-- i='海' i_mdi_twitter_circle=$i
-- i='渚' i_mdi_twitter_retweet=$i
-- i='漢' i_mdi_ubuntu=$i
-- i='煮' i_mdi_umbraco=$i
-- i='爫' i_mdi_umbrella=$i
-- i='琢' i_mdi_umbrella_outline=$i
-- i='碑' i_mdi_undo=$i
-- i='社' i_mdi_undo_variant=$i
-- i='祉' i_mdi_unfold_less_horizontal=$i
-- i='祈' i_mdi_unfold_more_horizontal=$i
-- i='祐' i_mdi_ungroup=$i
-- i='祖' i_mdi_untappd=$i
-- i='祝' i_mdi_upload=$i
-- i='禍' i_mdi_usb=$i
-- i='禎' i_mdi_vector_arrange_above=$i
-- i='穀' i_mdi_vector_arrange_below=$i
-- i='突' i_mdi_vector_circle=$i
-- i='節' i_mdi_vector_circle_variant=$i
-- i='練' i_mdi_vector_combine=$i
-- i='縉' i_mdi_vector_curve=$i
-- i='繁' i_mdi_vector_difference=$i
-- i='署' i_mdi_vector_difference_ab=$i
-- i='者' i_mdi_vector_difference_ba=$i
-- i='臭' i_mdi_vector_intersection=$i
-- i='艹' i_mdi_vector_line=$i
-- i='艹' i_mdi_vector_point=$i
-- i='著' i_mdi_vector_polygon=$i
-- i='褐' i_mdi_vector_polyline=$i
-- i='視' i_mdi_vector_selection=$i
-- i='謁' i_mdi_vector_triangle=$i
-- i='謹' i_mdi_vector_union=$i
-- i='賓' i_mdi_verified=$i
-- i='贈' i_mdi_vibrate=$i
-- i='辶' i_mdi_video=$i
-- i='逸' i_mdi_video_off=$i
-- i='難' i_mdi_video_switch=$i
-- i='響' i_mdi_view_agenda=$i
-- i='頻' i_mdi_view_array=$i
-- i='恵' i_mdi_view_carousel=$i
-- i='𤋮' i_mdi_view_column=$i
-- i='舘' i_mdi_view_dashboard=$i
-- i='﩮' i_mdi_view_day=$i
-- i='﩯' i_mdi_view_grid=$i
-- i='並' i_mdi_view_headline=$i
-- i='况' i_mdi_view_list=$i
-- i='全' i_mdi_view_module=$i
-- i='侀' i_mdi_view_quilt=$i
-- i='充' i_mdi_view_stream=$i
-- i='冀' i_mdi_view_week=$i
-- i='勇' i_mdi_vimeo=$i
-- i='勺' i_mdi_venmo=$i
-- i='喝' i_mdi_vk=$i
-- i='啕' i_mdi_vk_box=$i
-- i='喙' i_mdi_vk_circle=$i
-- i='嗢' i_mdi_vlc=$i
-- i='塚' i_mdi_voicemail=$i
-- i='墳' i_mdi_volume_high=$i
-- i='奄' i_mdi_volume_low=$i
-- i='奔' i_mdi_volume_medium=$i
-- i='婢' i_mdi_volume_off=$i
-- i='嬨' i_mdi_vpn=$i
-- i='廒' i_mdi_walk=$i
-- i='廙' i_mdi_wallet=$i
-- i='彩' i_mdi_wallet_giftcard=$i
-- i='徭' i_mdi_wallet_membership=$i
-- i='惘' i_mdi_wallet_travel=$i
-- i='慎' i_mdi_wan=$i
-- i='愈' i_mdi_watch=$i
-- i='憎' i_mdi_watch_export=$i
-- i='慠' i_mdi_watch_import=$i
-- i='懲' i_mdi_water=$i
-- i='戴' i_mdi_water_off=$i
-- i='揄' i_mdi_water_percent=$i
-- i='搜' i_mdi_water_pump=$i
-- i='摒' i_mdi_weather_cloudy=$i
-- i='敖' i_mdi_weather_fog=$i
-- i='晴' i_mdi_weather_hail=$i
-- i='朗' i_mdi_weather_lightning=$i
-- i='望' i_mdi_weather_night=$i
-- i='杖' i_mdi_weather_partlycloudy=$i
-- i='歹' i_mdi_weather_pouring=$i
-- i='殺' i_mdi_weather_rainy=$i
-- i='流' i_mdi_weather_snowy=$i
-- i='滛' i_mdi_weather_sunny=$i
-- i='滋' i_mdi_weather_sunset=$i
-- i='漢' i_mdi_weather_sunset_down=$i
-- i='瀞' i_mdi_weather_sunset_up=$i
-- i='煮' i_mdi_weather_windy=$i
-- i='瞧' i_mdi_weather_windy_variant=$i
-- i='爵' i_mdi_web=$i
-- i='犯' i_mdi_webcam=$i
-- i='猪' i_mdi_weight=$i
-- i='瑱' i_mdi_weight_kilogram=$i
-- i='甆' i_mdi_whatsapp=$i
-- i='画' i_mdi_wheelchair_accessibility=$i
-- i='瘝' i_mdi_white_balance_auto=$i
-- i='瘟' i_mdi_white_balance_incandescent=$i
-- i='益' i_mdi_white_balance_iridescent=$i
-- i='盛' i_mdi_white_balance_sunny=$i
-- i='直' i_mdi_wifi=$i
-- i='睊' i_mdi_wifi_off=$i
-- i='着' i_mdi_wii=$i
-- i='磌' i_mdi_wikipedia=$i
-- i='窱' i_mdi_window_close=$i
-- i='節' i_mdi_window_closed=$i
-- i='类' i_mdi_window_maximize=$i
-- i='絛' i_mdi_window_minimize=$i
-- i='練' i_mdi_window_open=$i
-- i='缾' i_mdi_window_restore=$i
-- i='者' i_mdi_windows=$i
-- i='荒' i_mdi_wordpress=$i
-- i='華' i_mdi_worker=$i
-- i='蝹' i_mdi_wrap=$i
-- i='襁' i_mdi_wrench=$i
-- i='覆' i_mdi_wunderlist=$i
-- i='視' i_mdi_xbox=$i
-- i='調' i_mdi_xbox_controller=$i
-- i='諸' i_mdi_xbox_controller_off=$i
-- i='請' i_mdi_xda=$i
-- i='謁' i_mdi_xing=$i
-- i='諾' i_mdi_xing_box=$i
-- i='諭' i_mdi_xing_circle=$i
-- i='謹' i_mdi_xml=$i
-- i='變' i_mdi_yeast=$i
-- i='贈' i_mdi_yelp=$i
-- i='輸' i_mdi_youtube_play=$i
-- i='遲' i_mdi_zip_box=$i
-- i='醙' i_mdi_surround_sound=$i
-- i='鉶' i_mdi_vector_rectangle=$i
-- i='陼' i_mdi_playlist_check=$i
-- i='難' i_mdi_format_line_style=$i
-- i='靖' i_mdi_format_line_weight=$i
-- i='韛' i_mdi_translate=$i
-- i='響' i_mdi_voice=$i
-- i='頋' i_mdi_opacity=$i
-- i='頻' i_mdi_near_me=$i
-- i='鬒' i_mdi_clock_alert=$i
-- i='龜' i_mdi_human_pregnant=$i
-- i='𢡊' i_mdi_sticker=$i
-- i='𢡄' i_mdi_scale_balance=$i
-- i='𣏕' i_mdi_account_card_details=$i
-- i='㮝' i_mdi_account_multiple_minus=$i
-- i='䀘' i_mdi_airplane_landing=$i
-- i='䀹' i_mdi_airplane_takeoff=$i
-- i='𥉉' i_mdi_alert_circle_outline=$i
-- i='𥳐' i_mdi_altimeter=$i
-- i='𧻓' i_mdi_animation=$i
-- i='齃' i_mdi_book_minus=$i
-- i='龎' i_mdi_book_open_page_variant=$i
-- i='﫚' i_mdi_book_plus=$i
-- i='﫛' i_mdi_boombox=$i
-- i='﫜' i_mdi_bullseye=$i
...
-- i='יִ' i_mdi_format_horizontal_align_center=$i
-- i='ﬞ' i_mdi_format_horizontal_align_left=$i
-- i='ײַ' i_mdi_format_horizontal_align_right=$i
...
-- i='ﬨ' i_mdi_meteor=$i
-- i='﬩' i_mdi_mixcloud=$i
-- i='שׁ' i_mdi_sigma_lower=$i
-- i='שׂ' i_mdi_source_branch=$i
-- i='שּׁ' i_mdi_source_merge=$i
-- i='שּׂ' i_mdi_tune=$i
-- i='אַ' i_mdi_webhook=$i
-- i='אָ' i_mdi_account_settings=$i
-- i='אּ' i_mdi_account_settings_variant=$i
-- i='בּ' i_mdi_apple_keyboard_caps=$i
-- i='גּ' i_mdi_apple_keyboard_command=$i
-- i='דּ' i_mdi_apple_keyboard_control=$i
-- i='הּ' i_mdi_apple_keyboard_option=$i
-- i='וּ' i_mdi_apple_keyboard_shift=$i
-- i='זּ' i_mdi_box_shadow=$i
-- i='﬷' i_mdi_cards=$i
-- i='טּ' i_mdi_cards_outline=$i
-- i='יּ' i_mdi_cards_playing_outline=$i
-- i='ךּ' i_mdi_checkbox_multiple_blank_circle=$i
-- i='כּ' i_mdi_checkbox_multiple_blank_circle_outline=$i
-- i='לּ' i_mdi_checkbox_multiple_marked_circle=$i
-- i='﬽' i_mdi_checkbox_multiple_marked_circle_outline=$i
-- i='מּ' i_mdi_cloud_sync=$i
-- i='﬿' i_mdi_collage=$i
-- i='נּ' i_mdi_directions_fork=$i
-- i='סּ' i_mdi_eraser_variant=$i
-- i='﭂' i_mdi_face=$i
-- i='ףּ' i_mdi_face_profile=$i
-- i='פּ' i_mdi_file_tree=$i
-- i='﭅' i_mdi_format_annotation_plus=$i
-- i='צּ' i_mdi_gas_cylinder=$i
-- i='קּ' i_mdi_grease_pencil=$i
-- i='רּ' i_mdi_human_female=$i
-- i='שּ' i_mdi_human_greeting=$i
-- i='תּ' i_mdi_human_handsdown=$i
-- i='וֹ' i_mdi_human_handsup=$i
-- i='בֿ' i_mdi_human_male=$i
-- i='כֿ' i_mdi_information_variant=$i
-- i='פֿ' i_mdi_lead_pencil=$i
