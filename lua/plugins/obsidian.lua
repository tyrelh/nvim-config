  ...
  opts = {
    ...
    ui = {
      ...
      hl_groups = {
        ...
        ObsidianTodo = { bold = true, fg = '#eed49f' },
        ObsidianDone = { bold = true, fg = '#81c8be' },
        ObsidianRightArrow = { bold = true, fg = '#f5a97f' },
        ObsidianTilde = { bold = true, fg = '#ee99a0' },
        ObsidianImportant = { bold = true, fg = '#ed8796' },
        ObsidianBullet = { bold = true, fg = '#70c0f0' },
        ObsidianRefText = { underline = true, fg = '#a890ff' },
        ObsidianExtLinkIcon = { fg = '#a890ff' },
        ObsidianTag = { italic = true, fg = '#70c0f0' },
        ObsidianBlockID = { italic = true, fg = '#70c0f0' },
        ObsidianHighlightText = { bg = '#c6a0f6' },
      },
    },
